...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="order-list">
    ...
    <div class="order-content">
      ...
      <div class="order-info"><a href="<?php echo $order['href']; ?>"><img src="catalog/view/theme/default/image/info.png" alt="<?php echo $button_view; ?>" title="<?php echo $button_view; ?>" class="img-responsive" /></a>&nbsp;&nbsp;<a href="<?php echo $order['reorder']; ?>"><img src="catalog/view/theme/default/image/reorder.png" alt="<?php echo $button_reorder; ?>" title="<?php echo $button_reorder; ?>"  class="img-responsive" /></a></div>
    </div>
  </div>
  <?php } ?>
